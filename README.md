...
Capstone 1 is an application with excellent use of responsive and mobile first modern design. Theres an aesthetic colour scheme borrowed from benance, used in it. The project is an application with an Home Page and an ABout page for both desktop and mobile version. 
...
```sh
  cd my-folder
  git clone git@github.com:umarahgul/Capstone-1.git
```
...
<ul>
<li>I would like to thank Microverse for providing a steep learning curve and making this project possible.</li>
<li>Credits for design go to Cindy Shin in Behance https://www.behance.net/adagio07</li>
